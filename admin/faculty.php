<<<<<<< Updated upstream:admin/faculty_add.php
<?php
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
              ...
              <div class="col-md-4" >
                <div class="card card-info" >
                  <div class="card-header">
                    ...
                    <a href="faculty_add.php" class="card-title" style="float: right;font-weight: bold;"><span>+</span>Add Faculty </a>
                  </div>
                  <div class="card-body">
    ...
    <script>
      $('.modalLink').click(function(){
          ...
          $.ajax({url:"function/getProfile_fun.php?mID="+mID+"&mName="+mName+"&mEmail="+mEmail+"&mMobile="+mMobile+"&mUsername="+mUsername+"&mPassword="+mPassword+"&mUsertype="+mUsertype+"&mStatus="+mStatus+"&mCreatedate="+mCreatedate+"&mUpdatedate="+mUpdatedate+"&get_faculty_page="+mGetfaculty,cache:false,success:function(result){
      ...
      $('.itemDelete').click(function(){
          ...
          if(!confirm('Are you sure you want to delete this faculty?')) return false;
           $.post('function/delete_fun.php', {'mID': mID, 'faculty_del_page': "faculty"}, function(result){
              alert(result);
              window.location = 'faculty_add.php';
          })
      });
    </script>
  </body>
...
>>>>>>> Stashed changes:admin/faculty.php
</html>