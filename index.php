<?php
    include('theme/header_student.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="row m-auto text-center flex">
        <div class="col-md-4">
            <a href="student/login.php" class="btn btn-primary btn-lg btn-block">
                <h3>Student Portal</h3>
            </a>
        </div>
        <div class="col-md-4">
            <a href="faculty/login.php" class="btn btn-success btn-lg btn-block">
...
<?php
include('theme/footer_student.php');
?>