              ...
              <div class="col-md-12" >
                <?php 
                  if($conn) {
                    ...
                    $sql1 = "SELECT a.id as aid,a.*,e.* FROM assignments as a, enrollments as e WHERE  e.sub_id=a.sub_id and e.std_id='".$facultyId."' ORDER BY a.id DESC";
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php 
                              ...
                              $assessmentId=$row['aid'];
                              $sqlAssess = "SELECT * FROM assignments_student WHERE stud_id='".$stdId."' and assignments_id='".$assessmentId."'";
                          ...
                          <form id="assignmentsSubmitForm" name="assignmentsSubmitForm" method="post">
                            ...
                            <input type="hidden" id="inputStudentID" name="inputStudentID" class="form-control" value="<?php echo $stdId;?>">
                            <input type="hidden" id="inputAssessmentID" name="inputAssessmentID" class="form-control" value="<?php echo $row['aid'];?>">
                            <td>
                            ...
                            <td>
                              <div class="upload-btn-wrapper" >
                                ...
                                <input type="file" id="inputAssignments" class="form-control" accept="image/*" name="inputAssignments"  accept="application/pdf" <?php if ($dueDate < $today){ echo "disabled"; } ?>>
                              </div>
                            </td>
