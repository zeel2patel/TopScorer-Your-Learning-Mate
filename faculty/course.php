              ...
              <div class="col-md-12" >
                <?php 
                  if($conn) {
                    ...
                    $status=1;
                    $sql1 = "SELECT c.*,sem.* FROM courses as c, subject as s,semesters as sem WHERE   s.faculty_id='".$facultyID."' and s.course_id=c.course_id and c.semester_id=sem.semester_id and c.status='".$status."' GROUP BY c.course_id ORDER BY s.sub_id DESC";
