...
<body class="main-bg">
  <div class="container-fluid">
    <div class="row">
      <?php
          if(!isset($_SESSION['select_semesters']) && !isset($_SESSION['select_course']) && !isset($_SESSION['select_subject'])){
      ?>
      ...
      <?php
          }else if(isset($_SESSION['select_semesters']) && isset($_SESSION['select_course']) && isset($_SESSION['select_subject'])){
      ?>
        ...
        <div class="register-container  animated flipInX">
          ...
          <div class="container-content">
            <form id="userSelfRegForm" name="userSelfRegForm" method="post" >
              ...
              <div><a class="text-whitesmoke btn btn-success"  href="login.php?login"><big>Are you sure! You want to Login now.</big></a></div>
              <br>
              <span class="statusMsg"></span>
            </form>
            <p class="margin-t text-whitesmoke text-c"><small> TopScorer &copy; 2024</small> </p>
